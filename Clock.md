...
In the above picture, we need to calculate what is the final clock cycle for PCKB by figuring out the output of corresponding selecters, and the original clock.
